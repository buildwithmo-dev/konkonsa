...
from routers.misc import search_router, clusters_router, alerts_router, jobs_router, analytics_router, settings_router
...
@app.get("/", tags=["Root"])
async def root():
    return {"name": "Konkonsa API", "docs": "/docs", "redoc": "/redoc", "health": "/healthz"}
